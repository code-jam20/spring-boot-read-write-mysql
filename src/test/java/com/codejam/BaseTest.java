...
public abstract class BaseTest {
    ...
    static final String BASE_URL = "http://localhost:8080/rw";
    ...
    static void databaseProperties(DynamicPropertyRegistry registry) {
        registry.add("spring.datasource.primary.url", DATABASE::getJdbcUrl);
        registry.add("spring.datasource.primary.username", DATABASE::getUsername);
        registry.add("spring.datasource.primary.password", DATABASE::getPassword);

        registry.add("spring.datasource.secondary.url", DATABASE::getJdbcUrl);
        registry.add("spring.datasource.secondary.username", DATABASE::getUsername);
        registry.add("spring.datasource.secondary.password", DATABASE::getPassword);
    }
